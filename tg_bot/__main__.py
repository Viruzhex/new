...
ഈ ബോട്ട്ം Carnival Cinemas ഗ്രൂപ്പിലേക്ക് ഉള്ളത് എന്ന് ഇനി വീണ്ടും വീണ്ടും പറയണോ??
...
It took lots of work for [my creator](t.me/DK369DK) to get me to where I am now, and every donation helps \
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username)),  InlineKeyboardButton(text="🤖 Make Own Admin Bot", url="https://youtu.be/W6CLKrehy6w")],
                     [InlineKeyboardButton(text="👥 Support Group", url="https://t.me/Carnival_Cinemas_Group"), InlineKeyboardButton(text="🔔 Update Channel", url="https://t.me/KochuUpdates")],
